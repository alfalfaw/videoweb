...
export class VideosController {
    ...
    //danmaku
    @Get('danmakuv2')
    @ApiOperation({ summary: '视频弹幕' })
    danmaku() {
        return { "code": 0, "data": [[1.040035, 0, 16769331, "DIYgod", "jgjgjhgjhgjhg"], [5.179043, 0, 16777215, "DIYgod", "4545455"], [6.53892, 0, 16777215, "DIYgod", "4545455"], [14.693861, 0, 16777215, "DIYgod", "898989"], [4.099625, 0, 16777215, "DIYgod", "123"], [1.859125, 0, 16777215, "DIYgod", "测试测试测试测试测试测试测试测试测试"], [2.830849, 0, 16777215, "DIYgod", "测试测试测试测试测试测试测试测试测试"], [6.568743, 0, 16777215, "DIYgod", "666"], [22.314408, 0, 16777215, "DIYgod", "111"]] }
